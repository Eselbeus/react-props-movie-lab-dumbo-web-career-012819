...
import MovieShowcase from '../MovieShowcase.js'
  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardBack title={this.props.title} poster={this.props.poster} genres={this.props.genres} IMDBRating={this.props.IMDBRating}/>
      </div>
    )
  }
}
